...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		$("#submitBtn").click(function()
		{
			...
			if($("#positionName").val()=="" || $("#positionMin").val()=="")
			{
		...
		<form action="positioninsert.action" method="post" id="positionForm">
			<table>
				<tr>
					<th>직위명</th>
					<td>
						<input type="text" id="positionName" name="positionName" placeholder="추가할 직위이름">
					</td>
				</tr>
				<tr>
					<th>최소기본급</th>
					<td>
						<input type="text" id="positionMin" name="positionMin" placeholder="추가할 최소기본급">
					</td>
				</tr>
				<tr>
