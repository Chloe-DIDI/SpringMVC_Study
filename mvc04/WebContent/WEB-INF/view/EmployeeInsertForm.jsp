			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<input type="text" id="ssn2" name="ssn2" style="width:110px;" placeholder="뒷 7자리">
					</td>
				</tr>
				<tr>
					<th>생년월일</th>
						...
						<select id="departmentId" name="departmentId" >
							...
							-->
							 ...
							 <c:forEach var="department" items="${departmentList }">
							 	...
							 	onclick="check()">${department.departmentName }</option>
							 </c:forEach>
						</select>
					</td>
				</tr>
				<tr>
					...
					<!-- 선생님 제가 돈 형태로 나오게 ajax.jsp에서 바꿨었어요.. -->
					<!-- 그걸 바꾸려면 Ajax.jsp 에서 바꾸는게 아니고... 데이터 표현하는 뷰에서 바꿔야 하는거야 ㅎ
					이거떄문에 문제 생긴건가여??   응 그래 보이는데
					-->
				</tr>
				<tr>
					<th>기본급</th>
